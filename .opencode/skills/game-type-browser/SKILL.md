...
description: 浏览和提取 Kingdom Two Crowns 游戏程序集的类型信息。用于搜索游戏类型、提取类成员信息（方法、属性、字段）、查看方法实现代码。当 用户或 AI Agent 需要了解游戏 API、查找特定游戏类或查看游戏代码实现时使用此技能。触发场景包括："查找游戏中的地图类"、"提取 PlayerController 的方法"、"查看某方法的实现"等。
---
...
所有功能通过 `ilspycmd` 工具实现，该工具已在环境中安装（版本 10.0.0.8282）。
